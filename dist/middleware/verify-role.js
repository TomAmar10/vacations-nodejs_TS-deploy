...
var verifyRole = function (role) {
    return function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var authHeader, user, isValid;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authHeader = request.header("authorization");
                    user = jwt_helper_1.default.getUserFromToken(authHeader);
                    return [4 /*yield*/, jwt_helper_1.default.verifyToken(authHeader)];
                case 1:
                    isValid = _a.sent();
                    if (!isValid) {
                        next(new errorModel_1.default(403, "inValid or expired token"));
                        return [2 /*return*/];
                    }
                    if (user.role > role) {
                        next(new errorModel_1.default(403, "You are not permitted !"));
                        return [2 /*return*/];
                    }
                    next();
                    return [2 /*return*/];
