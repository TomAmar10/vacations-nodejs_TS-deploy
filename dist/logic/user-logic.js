    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                if (!users.length)
                    throw new errorModel_1.default(204, "no users found");
                return [2 /*return*/, users];
        }
    });
}); };
var getAllUsernames = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sql, users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user[0])
                    throw new errorModel_1.default(204, "no user found");
